...
public class UseSchemaIT extends ParallelStatsDisabledIT {
    ...
    public void testMappedView() throws Exception {
        ...
        HTableDescriptor h3 = (new HTableDescriptor(fullTablename));
        h3.addFamily(new HColumnDescriptor(QueryConstants.DEFAULT_COLUMN_FAMILY_BYTES));
        admin.createTable(h3);
