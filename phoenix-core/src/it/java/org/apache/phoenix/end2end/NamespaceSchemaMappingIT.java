...
public class NamespaceSchemaMappingIT extends ParallelStatsDisabledIT {
    ...
    public void testBackWardCompatibility() throws Exception {
        ...
        HTableDescriptor h1 =  new HTableDescriptor(TableName.valueOf(namespace, tableName));
        h1.addFamily(new HColumnDescriptor(QueryConstants.DEFAULT_COLUMN_FAMILY_BYTES));
        admin.createTable(h1);
        HTableDescriptor h2 =  new HTableDescriptor(TableName.valueOf(phoenixFullTableName));
        h1.addFamily(new HColumnDescriptor(QueryConstants.DEFAULT_COLUMN_FAMILY_BYTES));
        admin.createTable(h2);
